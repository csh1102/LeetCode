...
//from 0 to n - 1 in a clockwise direction, and each vertex has exactly one monkey. 
...
//the movement or intersect on an edge. 
//
// Return the number of ways the monkeys can move so that at least one 
//collision happens. Since the answer may be very large, return it modulo 109 + 7. 
//
...
//anticlockwise direction; monkey 3 moves in a clockwise direction. Monkeys 1 and 3 
//collide.
...
// 
//
// Related Topics Math Recursion 👍 170 👎 478
